...
document.writeln('								<a href="#" class="dropdown-toggle" data-toggle="dropdown">我的荣耀<b class="caret"></b></a>');
...
document.writeln('												<h6><a href="productsSpec.html?company=Iris">打怪得装备</a></h6>');
document.writeln('												<h6><a href="giveSpec.html?company=Iris">游戏内赠与</a></h6>');
document.writeln('											</ul>');
document.writeln('										</div>');
document.writeln('										<div class="clearfix"></div>');
document.writeln('										<div class="clearfix"></div>');
